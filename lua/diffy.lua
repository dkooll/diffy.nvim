...
--- Extract items from ignore_changes array in a lifecycle block
...
function M.validate_resources()
  ...
  M.fetch_schema(function()
    ...
    for _, resource in ipairs(resources) do
      local schema = schema_cache.resource_schemas and schema_cache.resource_schemas[resource.type]
